...
const ProductDetails = () => {
  ...
  const {items,addItems,incrementItem,decrementItem} = useCartStore();
...
const totalPrice = (product.price * quantity).toFixed(2);
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={{padding:16,flex:1}}>
        ...
        <Text style={styles.price}>Unit Price : Rs {product.price.toFixed(2)}</Text>
 ...
 <Text style={styles.quantityButtonText}> + </Text>
          ...
          <TouchableOpacity style={[styles.addToCartButton,{opacity : quantity ===0 ? 0.5 :1}]} onPress={addToCart} disabled={quantity === 0}>
