...
export default function Cart() {
    ...
    const {items,addItems,incrementItem,decrementItem,getTotalPrice,removeItem} = useCartStore();
    ...
    return <View style={styles.container}>
        ...
        <FlatList  data={items} keyExtractor={item => item.id.toString()}
            renderItem={({item})=><CartItem item={item} onRemove={removeItem} onIncrement={incrementItem}
